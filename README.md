...
I'm still working on the project so it's not in its final version yet. There are a lot of styling yet to be added, refactoring and I need to add the functionality related to the border countries on the detail page
...
- Website - [Tonika](https://tonika.tech)
...
```
git clone https://github.com/tokich6/countries.git
```
